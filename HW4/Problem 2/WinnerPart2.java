...
public class WinnerPart2 implements Callable<String>
{
    ...
    public WinnerPart2(LinkedList<PlayerPart2> players, int numOfPlayers)
    {
    ...
    public String call()
    {
        PlayerPart2 playerInAction;
        LinkedList<PlayerPart2> loserPool = new LinkedList<>();
